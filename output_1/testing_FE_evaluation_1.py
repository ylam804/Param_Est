...
from new_evaluate_hessian import new_evaluate_hessian_method
import numpy as np
import math
...
initial_parameter = np.array([1.234, 8.4378])
...
ps.simulation.set_Neo_Hookean_two_layer(initial_parameter)
