...
gfx modify g_element "/" points domain_datapoints coordinate coordinates tessellation default_points LOCAL glyph sphere size "1*1*1" offset 0,0,0 font default select_on material default selected_material default_selected render_shaded;
gfx modify g_element "/" points domain_datapoints coordinate error_1 tessellation default_points LOCAL glyph arrow size "1*1*1" offset 0,0,0 font default orientation error_1 scale_factors "1*1*1" select_on material default selected_material default_selected render_shaded;
